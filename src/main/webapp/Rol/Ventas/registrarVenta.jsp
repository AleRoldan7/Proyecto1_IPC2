            ...
            <%
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    if (productosSeleccionados != null && productosSeleccionados.length > 0) {
                        ...
                        out.print("<div class='alert alert-success mt-3'>¡Compra realizada con éxito! Precio Total: </div>");
                    } else {
                        out.print("<div class='alert alert-danger mt-3'>No has seleccionado ningún producto.</div>");
                    }
                }
            %>
